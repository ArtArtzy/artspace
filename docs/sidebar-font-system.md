...
| `.sidebar-link` | 10px | 500 | 1.25 | ลิงก์เสริม เช่น “ดูทั้งหมด” |
| `.sidebar-item-title` | 11px | 500 | 1.25 | ชื่อเรื่อง ชื่อนักเขียน ชื่อหัวข้อ |
| `.sidebar-meta` | 10px | 400 | 1.25 | ผู้เขียน ตอน จำนวน หรือข้อมูลประกอบ |
| `.sidebar-caption` | 9px | 400 | 1.3 | วันที่ ข้อความรอง และรายละเอียดที่สำคัญรองลงมา |
| `.sidebar-body` | 12px | 400 | 1.5 | รีวิว คำอธิบาย และข้อความเนื้อหา |
| `.sidebar-button` | 9px | 500 | 1 | ปุ่มย่อย เช่น “เขียนรีวิว” หรือ “เริ่มอ่าน” |
...
- หลีกเลี่ยงข้อความที่ผู้ใช้ต้องอ่านต่ำกว่า 9px
