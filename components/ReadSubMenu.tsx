...
export default function ReadSubMenu({ activeMode, fixed = false }: ReadSubMenuProps) {
  return (
    <nav
      ...
      className={`${fixed ? "fixed inset-x-0 top-[82px] z-40" : ""} mx-auto flex h-[64px] w-full max-w-[1400px] items-center justify-center border-t border-arn-accent/30 bg-arn-canvas px-10 text-arn-text backdrop-blur-sm`}
    >
