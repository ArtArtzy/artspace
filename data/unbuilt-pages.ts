...
export const unbuiltPages: readonly UnbuiltPage[] = [
  ...
  {
    code: "HOME-FOLLOWING-001",
    name: "หน้ารวมเรื่องจากที่ติดตาม",
    url: "/read?category=จากที่ติดตาม",
    trigger: "ดูทั้งหมดในทุก Section จากที่ติดตาม หน้าแรก",
    status: "ยังไม่ได้ทำ",
  },
  {
    code: "HOME-COMPLETED-REVIEWS-001",
    name: "หน้ารวมเรื่องที่รอรีวิวจากคุณ",
    url: "/read?section=completed-reviews",
    trigger: "ดูทั้งหมดใน Sidebar รอรีวิวจากคุณ หน้าแรก",
    status: "ยังไม่ได้ทำ",
  },
  {
    code: "HOME-COMPLETED-FOLLOWING-001",
    name: "หน้ารวมเรื่องจบที่คุณติดตาม",
    url: "/read?section=completed-following",
    trigger: "ดูทั้งหมดใน Sidebar เรื่องจบที่คุณติดตาม หน้าแรก",
    status: "ยังไม่ได้ทำ",
  },
  {
  ...
  {
    code: "COMMUNITY-RULES-001",
    name: "หน้ากติกาชุมชน",
    url: "/community/rules",
    trigger: "ปุ่มกติกาชุมชนใน Hero ชุมชน",
    status: "ยังไม่ได้ทำ",
  },
  {
  ...
  {
    code: "COMMUNITY-FEED-LATEST-001",
    name: "หน้ารวมกระทู้พูดคุยล่าสุด",
    url: "/community?section=discussion&filter=latest",
    trigger: "ดูทั้งหมดใน Section พูดคุยล่าสุด หน้า สำหรับคุณ",
    status: "ยังไม่ได้ทำ",
  },
  {
    code: "COMMUNITY-FEED-THREAD-001",
    name: "หน้ารายละเอียดกระทู้จากหน้า สำหรับคุณ",
    url: "/community/posts/:slug?from=community-feed",
    trigger: "กด List กระทู้ในทุก Section ของหน้า สำหรับคุณ",
    status: "ยังไม่ได้ทำ",
  },
  {
    code: "COMMUNITY-DISCUSSION-THREAD-001",
    name: "หน้ารายละเอียดกระทู้จากหน้า พูดคุย",
    url: "/community/posts/:slug?from=community-discussion",
    trigger: "กดกระทู้ทุก List ในหน้า ชุมชน > พูดคุย",
    status: "ยังไม่ได้ทำ",
  },
  {
    code: "COMMUNITY-DISCUSSION-REPLIES-LIST-001",
    name: "หน้ารวมกระทู้ที่คุณตอบล่าสุด",
    url: "/community/discussion/recent-replies",
    trigger: "ดูทั้งหมดใน Sidebar กระทู้ที่คุณตอบล่าสุด หน้า ชุมชน > พูดคุย",
    status: "ยังไม่ได้ทำ",
  },
  {
    code: "COMMUNITY-WRITERS-THREAD-001",
    name: "หน้ารายละเอียดกระทู้จากห้องนักเขียน",
    url: "/community/posts/:slug?from=community-writers",
    trigger: "กดกระทู้ทุก List ในหน้า ชุมชน > ห้องนักเขียน",
    status: "ยังไม่ได้ทำ",
  },
  {
  ...
  {
    code: "COMMUNITY-TOPICS-LIST-001",
    name: "หน้ารวมกระทู้ตามหัวข้อ",
    url: "/community/topics",
    trigger: "ดูทั้งหมดใน Sidebar กำลังพูดถึง",
    status: "ยังไม่ได้ทำ",
  },
  {
